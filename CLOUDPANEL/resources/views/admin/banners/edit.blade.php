...
<div class="mb-6">
    ...
    <h1 class="text-3xl font-bold text-gray-800 mt-2">Editar Banner</h1>
</div>
    ...
    <form action="{{ route('admin.banners.update', $banner) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <img src="{{ asset('storage/' . $banner->image) }}" alt="{{ $banner->title }}" class="max-h-48 rounded-lg border">
            </div>
            @endif
            ...
            <div class="md:col-span-2">
                ...
                <p class="text-xs text-gray-500 mt-1">Formatos: JPEG, PNG, WebP. Deja vacío para mantener la imagen actual. Tamaño recomendado: 1920x600px. Máximo 2MB.</p>
