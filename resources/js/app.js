...
// ============================================
// IMPORTACIONES - Modal de errores
// ============================================

window.showErrorModal = function(errorMessage) {
...
// Cerrar modal de errores con tecla ESC
...
// ============================================
// IMPORTACIONES - Modal de procesamiento
// ============================================
...
// Inicializar formularios de importación y actualización
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (importForm) {
        importForm.addEventListener('submit', function(e) {
            ...
            if (fileInput && fileInput.files.length > 0) {
                ...
                setTimeout(() => updateProcessingStep('Validando cabeceras del archivo...'), 500);
                setTimeout(() => updateProcessingStep('Procesando productos...'), 1500);
                setTimeout(() => updateProcessingStep('Guardando en la base de datos...'), 3000);
            }
        });
    }
    ...
    if (updateForm) {
        updateForm.addEventListener('submit', function(e) {
            ...
            if (fileInput && fileInput.files.length > 0) {
                ...
                setTimeout(() => updateProcessingStep('Validando cabeceras del archivo...'), 500);
                setTimeout(() => updateProcessingStep('Buscando productos existentes...'), 1500);
                setTimeout(() => updateProcessingStep('Actualizando productos...'), 3000);
            }
        });
    }
});
